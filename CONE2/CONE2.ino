...
const double CONE1_LAT =  -23.64731979;  // latitudes e longitudes dos cones  Location: -23.64731979,-46.57261657
const double CONE1_LNG =  -46.57261657;
const double CONE2_LAT =  -23.64721298;   // Location: -23.64721298,-46.57278060
const double CONE2_LNG =  -46.57278060;   
const double CONE3_LAT =  -15.765286;
const double CONE3_LNG =  -47.871986;
const double INICIO_LAT = -23.64697074;      // latitude e longitude do ponto inicial    Location: -23.64697074,-46.57278060
const double INICIO_LNG = -46.57278060;
const double DIRECAO_IMU_CONE1 = 24.00;   // angulo da IMU para os cone 
const double DIRECAO_IMU_CONE2 = -11;
