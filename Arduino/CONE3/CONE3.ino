...
const double DIRECAO_IMU_CONE1 = 46;   // angulo da IMU para os cone //-22 // 34 //40.8 //45 //48
const double DIRECAO_IMU_CONE2 = -99.00; //-97 //-95 //-103.6

const double DIRECAO_IMU_CONE25 = 100;  // direto pro cone 3: -176 //  
const double DIRECAO_IMU_CONE3 = -140;    // indo direto 125
