...
const float LIMITEREAL0 = 40;  
const float LIMITEREAL90 = 114;
const float LIMITENEGATIVOREAL90 = -19.9;
const float LIMITEREAL180 = -167.9;    //-176; // Deve ser um valor um pouco maior que -180 da bussóla nao normalizada (Cerca de -178~-172)
