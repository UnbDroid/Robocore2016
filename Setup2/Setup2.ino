...
const float LIMITEREAL0 = -26;  
const float LIMITEREAL90 = 24;
const float LIMITENEGATIVOREAL90 = -78;
const float LIMITEREAL180 = -178;    //-176; // Deve ser um valor um pouco maior que -180 da bussóla nao normalizada (Cerca de -178~-172)
...
const double CONE1_LAT =  -23.64689064;  // latitudes e longitudes dos cones  Location: -23.64689064,-46.57221221
const double CONE1_LNG =  -46.57221221;
const double CONE2_LAT =  -23.64679908;   // Location: -23.64679908,-46.57240295
const double CONE2_LNG =  -46.57240295;   
const double CONE3_LAT =  -23.64659881;  // -23.64659881,-46.57223892
const double CONE3_LNG =  -46.57223892;
const double INICIO_LAT = -23.64652442;      // latitude e longitude do ponto inicial    Location: -23.64652442,-46.57240676
const double INICIO_LNG = -46.57240676;
const double DIRECAO_IMU_CONE1 = 24;   // angulo da IMU para os cone 
const double DIRECAO_IMU_CONE2 = -96;
const double DIRECAO_IMU_CONE3 = -109.5;
  ...
  if((valor1>limite1)&&(valor2>limite2)){
    ...
    if(valor2 <limite2){
      Serial.println("To no marco 1");
        ...
        //delay(100);
        parar();                  
        if (!C1 && !C2 && !C3 && flag_LUZ){
          C1 = true;
          flag_LUZ = 0;
          tempo = millis();
          
        }else if (C1 && !C2 && !C3 && flag_LUZ){
          C2 = true;
          flag_LUZ = 0;
          tempo = millis();
        }else if (C1 && C2 && !C3 && flag_LUZ){
