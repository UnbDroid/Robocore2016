...
const double CONE1_LAT =  -23.64730644;  // latitudes e longitudes dos cones  Location: -23.64730644,-46.57260894  //,  -23.64730644,-46.57263183
const double CONE1_LNG =  -46.57263183 ; //-46.57260894
const double CONE2_LAT =  -23.64721679;   // Location:  -23.64721298,-46.57278442 //, // -23.64721298 // -23.64721679,-46.57279205
const double CONE2_LNG =  -46.57279205;   // -46.57278442
...
const double INICIO_LAT = -23.64695739;      // latitude e longitude do ponto inicial    Location: -23.64695739,-46.57279586
const double INICIO_LNG = -46.57279586;

//Valores de IMU lidos no inicio
const double DIRECAO_IMU_CONEI1 = 41.9;   // angulo da IMU para os cone //-22 // 34 //40.8 //45 //48
const double DIRECAO_IMU_CONEI2 = 16.5;
const double DIRECAO_IMU_CONEI3 = 90.3;

//Valores de IMU lidos no CONE1
const double DIRECAO_IMU_CONE12 = -100.7; //-97 //-95 //-103.6
const double DIRECAO_IMU_CONE13 = -144.7;

//Valores de IMU lidos no CONE2 
const double DIRECAO_IMU_CONE21 = 72.4;
...
const double DIRECAO_IMU_CONE253 = -110;    // indo direto 125

//Valores de IMU lidos no CONE3
const double DIRECAO_IMU_CONE31 = 21;    
const double DIRECAO_IMU_CONE32 = -12.8;
...
void Alinhar (){
  ...
  if (DIRECAO_CORRECAO > 4.5 && DIRECAO_CORRECAO < 10) {
   // reduzir velocidade
  // virar o robô no sentido anti-horário
      Serial.println("Corrigindo para esquerda");
      esquerda(170, 210);
  }  
  else if (DIRECAO_CORRECAO < -4.5 && DIRECAO_CORRECAO > -10) {
   // reduzir velocidade
