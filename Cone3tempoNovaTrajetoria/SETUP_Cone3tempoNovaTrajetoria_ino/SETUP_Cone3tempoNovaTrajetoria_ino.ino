...
const double CONE1_LAT =  -23.64732360;  // latitudes e longitudes dos cones  Location: -23.64730644,-46.57260894  //, // -23.64730644
const double CONE1_LNG =  -46.57262802 ; //-46.57260894
const double CONE2_LAT =  -23.64722442;   // Location:  -23.64721298,-46.57278442 //, // -23.64721298
const double CONE2_LNG =  -46.57280731;   // -46.57278442
const double CONE25_LAT =  -23.64709091;   // Location: -23.64706611,-46.57263565 para ir direto: -23.64703750,-46.57268142
const double CONE25_LNG =  -46.57264328;   
const double CONE3_LAT =  -23.64700126;      // -23.64700126,-46.57264709
const double CONE3_LNG =  -46.57264709;
const double INICIO_LAT = -23.64697456;      // latitude e longitude do ponto inicial    Location:  -23.64697456,-46.57277297
const double INICIO_LNG = -46.57277297;
const double INICIO2_LAT = -23.64697456;      // latitude e longitude do ponto inicial    Location:  -23.64697456,-46.57277297
const double INICIO2_LNG = -46.57277297;
const double INICIO3_LAT = -23.64697456;      // latitude e longitude do ponto inicial    Location:  -23.64697456,-46.57277297
const double INICIO3_LNG = -46.57277297;

//Valores de IMU lidos no inicio
const double DIRECAO_IMU_CONEI1 = 46;   // angulo da IMU para os cone //-22 // 34 //40.8 //45 //48
const double DIRECAO_IMU_CONEI2 = 00;
const double DIRECAO_IMU_CONEI3 = 00;

//Valores de IMU lidos no CONE1
const double DIRECAO_IMU_CONE12 = -99.00; //-97 //-95 //-103.6
const double DIRECAO_IMU_CONE13 = 00;

//Valores de IMU lidos no CONE2 
const double DIRECAO_IMU_CONE21 = 00;
//Direcao da IMU do cone 2 apontado pro 25
const double DIRECAO_IMU_CONE25 = 100;  // direto pro cone 3: -176 //  

//Valores de IMU lidos no CONE25
const double DIRECAO_IMU_CONE253 = -140;    // indo direto 125

//Valores de IMU lidos no CONE3
const double DIRECAO_IMU_CONE31 = 00;    
const double DIRECAO_IMU_CONE32 = 00;

const double COURSE_CONEI1 = atan2((CONE1_LNG - INICIO_LNG),(CONE1_LAT - INICIO_LAT));   // ângulos de trajetória iniciais para cada cone
const double COURSE_CONEI2 = atan2 ((CONE2_LNG - INICIO_LNG),(CONE2_LAT - INICIO_LAT));
const double COURSE_CONEI3 = atan2 ((CONE3_LNG - INICIO_LNG),(CONE3_LAT - INICIO_LAT));

const double COURSE_CONE12 = atan2((CONE2_LNG - CONE1_LNG),(CONE2_LAT - CONE1_LAT));
const double COURSE_CONE13 = atan2((CONE3_LNG - CONE1_LNG),(CONE3_LAT - CONE1_LAT));

const double COURSE_CONE25 = atan2((CONE25_LNG - CONE2_LNG),(CONE25_LAT - CONE2_LAT));
const double COURSE_CONE21 = atan2 ((CONE1_LNG - CONE2_LNG),(CONE1_LAT - CONE2_LAT));

const double COURSE_CONE253 = atan2((CONE3_LNG - CONE25_LNG),(CONE3_LAT - CONE25_LAT));

const double COURSE_CONE31 = atan2 ((CONE1_LNG - CONE3_LNG),(CONE1_LAT - CONE3_LAT));
const double COURSE_CONE32 = atan2 ((CONE2_LNG - CONE3_LNG),(CONE2_LAT - CONE3_LAT));

double COURSE_ATUAL = 0; 
double DELTA_COURSE = 0;  
double IMU_CORRIGIDA = DIRECAO_IMU_CONEI1;
double DISTANCIA = 0;

double IMU_CORRIGIDA3 = DIRECAO_IMU_CONEI1;
double IMU_CORRIGIDA2 = DIRECAO_IMU_CONEI1;
double IMU_CORRIGIDA1 = DIRECAO_IMU_CONEI1;
...
void calculate_IMU(){
    ...
    Serial.print("Angulo para fazer SETUP: ");
...
void CalculoDirecao (){
  ...
  if (!C1 && !C2 && !C25 && !C3) {
    ...
    DELTA_COURSE = COURSE_ATUAL - COURSE_CONEI1;
    ...
    IMU_CORRIGIDA1 = DIRECAO_IMU_CONEI1 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
    
    Serial.println("DELTA COURSE1");
    Serial.println(DELTA_COURSE);
   
    DELTA_COURSE = COURSE_ATUAL - COURSE_CONE21;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA2 = DIRECAO_IMU_CONE21 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
    
    Serial.println("DELTA COURSE2");
    Serial.println(DELTA_COURSE);

    DELTA_COURSE = COURSE_ATUAL - COURSE_CONE31;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA3 = DIRECAO_IMU_CONE31 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
  
    Serial.println("DELTA COURSE3");
    Serial.println(DELTA_COURSE);

    IMU_CORRIGIDA = (IMU_CORRIGIDA1 + IMU_CORRIGIDA2 + IMU_CORRIGIDA3)/3;
  }  
  ...
  if (C1 && !C2 && !C25 && !C3) {
    ...
    DELTA_COURSE = COURSE_ATUAL - COURSE_CONE12;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA1 = DIRECAO_IMU_CONE12 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
    
    Serial.println("DELTA COURSE1");
    Serial.println(DELTA_COURSE);

    DELTA_COURSE = COURSE_ATUAL - COURSE_CONEI2;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA2 = DIRECAO_IMU_CONEI2 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
    
    Serial.println("DELTA COURSE2");
    Serial.println(DELTA_COURSE);

    DELTA_COURSE = COURSE_ATUAL - COURSE_CONE32;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA3 = DIRECAO_IMU_CONE32 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
  ...
  // Ja achou cones 1, 2 e 25
   if (C1 && C2 && C25 && !C3) {
    ...
    DELTA_COURSE = COURSE_ATUAL - COURSE_CONE13;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA1 = DIRECAO_IMU_CONE13 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
    
    Serial.println("DELTA COURSE1");
    Serial.println(DELTA_COURSE);

    DELTA_COURSE = COURSE_ATUAL - COURSE_CONEI3;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA2 = DIRECAO_IMU_CONEI3 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
  
    Serial.println("DELTA COURSE2");
    Serial.println(DELTA_COURSE);

    DELTA_COURSE = COURSE_ATUAL - COURSE_CONE253;
    DELTA_COURSE = TO_DEG(DELTA_COURSE);
    DELTA_COURSE = ArrumarAngulo(DELTA_COURSE);
    // define a orientação da IMU corrigida do robô a partir da orientação do gps
    IMU_CORRIGIDA3 = DIRECAO_IMU_CONE253 - DELTA_COURSE;  // Verificar se é menos mesmo!!!
  ...
  Serial.println("IMU CORRIGIDA1");
  Serial.println(IMU_CORRIGIDA1);
  Serial.println("IMU CORRIGIDA2");
  Serial.println(IMU_CORRIGIDA2);
  Serial.println("IMU CORRIGIDA3");
  Serial.println(IMU_CORRIGIDA3);
...
void AjustarPosicao (){
  ...
  if (C1 && !C2 && !C25 && !C3){
    IMU_CORRIGIDA = DIRECAO_IMU_CONE12;        
  }
  ...
  if (C1 && C2 && C25 && !C3){
     IMU_CORRIGIDA = DIRECAO_IMU_CONE253;      
  }
  Alinhar();
}
...
void loop(){
  ...
  if (comando == 'L' && start == 1){
    ...
    if(C1 && C2 && !C25 && !C3 &&  ((millis() - tempo) >= 10000)  ){
       C25 = true;
       IMU_CORRIGIDA = DIRECAO_IMU_CONE253;
    }
    Alinhar();  
